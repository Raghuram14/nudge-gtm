...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Nudgeio measures team and process health, system bottlenecks, delivery outcomes, and explainable evidence - not employee surveillance, productivity rankings, or hours online.",
...
export default function Page(): React.ReactElement {
  return (
    ...
    >
      <p>
        Nudgeio is for team and process health, system bottlenecks, delivery outcomes, and
