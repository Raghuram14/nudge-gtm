...
export const solutions: ReadonlyArray<SolutionEntry> = [
  {
    ...
    belief:
      "Nudgeio connects evidence and context so leadership can understand engineering reality faster.",
  ...
  },
  {
    ...
    belief: "Nudgeio creates a shared view across teams and systems.",
    cta: "See how it works",
  },
  {
    title: "Engineering Manager",
    problem: "Hard to reconstruct why work slowed, changed direction, or created follow-up work.",
    belief: "Nudgeio preserves the context behind engineering activity.",
  ...
  },
  {
    ...
    belief: "Nudgeio makes technical context easier to retrieve and connect.",
    cta: "See the knowledge graph",
  },
  {
    title: "Platform / DevEx leader",
    problem: "Tooling generates data but not enough actionable context.",
    belief: "Nudgeio turns engineering telemetry into explainable intelligence.",
